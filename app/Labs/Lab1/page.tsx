...
export default function Lab1() {
    return (
           ...
           <div id = "wd-p-tag">
            ...
            <div id = "wd-lists">
                ...
                <ol id="wd-your-favorite-recipe">
                    <li>Marinate meat with spices.</li>
                    <li>Wash and soak rice.</li>
                    <li>Cook rice till half.</li>
                    <li>Fry onions till golden.</li>
                    <li>Add tomatoes, chilies, meat.</li>
                    <li>Layer rice over masala.</li>
                    <li>Add saffron, herbs, onions.</li>
                    <li>Steam on low, serve and enjoy!</li>
                </ol>
               ...
               <ul id="wd-my-books">
                ...
                <ul id="wd-your-books">        
                    <li>Darkly Dreaming Dexter</li>
                    <li>The Lightning Thief</li>
                    <li>Dearly Devoted Dexter</li>
                    <li>Gone Girl</li>
                    <li>The Ritual</li>
                </ul>
            </div>
        ...
        <h4>Anchor tag</h4>
        Please
        <a href="https://github.com/karanlaksh/kambaz-next-js" id="wd-github"> click here </a>
        to navigate to my github repository<br/>
