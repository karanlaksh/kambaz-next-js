...
export default function TOC() {
  ...
  return (
    <Nav variant="pills">
      ...
      <NavItem>
        <NavLink href="https://github.com/karanlaksh/kambaz-next-js">
          Frontend Repo
        </NavLink>
      </NavItem>
      <NavItem>
        <NavLink href="https://github.com/karanlaksh/kambaz-node-server-app">
          Backend Repo
        </NavLink>
      </NavItem>
      <NavItem>
        <NavLink href="https://kambaz-node-server-app-ivx7.onrender.com">
          Remote Server
        </NavLink>
      </NavItem>
    </Nav>
